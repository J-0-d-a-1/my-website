...
export default function Skills() {
  ...
  return (
    <section id="skills" className="max-w-5xl mx-auto px-6 md:px-10 pt-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {skillGroups.map((group) => (
          <div
            key={group.key}
            className="bg-bg-2 border border-white/[0.08] rounded-[4px] p-4 md:p-5 min-w-0"
          >
            <p className="text-[0.68rem] font-mono tracking-[0.15em] uppercase text-accent-gold mb-3 wrap-break-word">
              {t(`groups.${group.key}`)}
            </p>
            <ul>
